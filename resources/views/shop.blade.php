...
<div class="row">
    ...
    <div class="col-lg-4 m-auto shadow">
        ...
        <div class="card">
            <div class="card-header ">
                <h5 class="card-title text-success">Información especificada</h5>
            </div>
            <div class="card-body">
                <div style="text-align: center; margin: 0 auto; max-width: 100%;">
                    <img src="assets/img/welcome.png"  alt="Volcano Turri"
    ...
    <div class="col-lg-4 m-auto shadow">
        ...
        <div class="card">
            <div class="card-header text-success">
                <h5 class="card-title text-success">Temperatura 16°</h5>
            </div>
            <div class="card-body">
                <div style="text-align: center; margin: 0 auto; max-width: 100%;">
                    <img src="assets/img/vt2.jpg"  alt="Volcano Turri"
                    style="max-width: 100%; height: auto; display: block; margin: 0 auto;">
                  </div>
            </div>
        </div>
    ...
    <div class="col-lg-4 m-auto shadow">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div style="text-align: center; margin: 0 auto; max-width: 100%;">
                    <img src="assets/img/vt1.jpg"  alt="Volcano Turri"
                    style="max-width: 100%; height: auto; display: block; margin: 0 auto;">
                  </div>
            </div>
        </div>
...
<div><br></div>
            ...
            <div class="row">
                <div class="col-lg-4 m-auto shadow"> 
                    <div style="text-align: center; margin: 0 auto; max-width: 100%;">
                        <img src="assets/img/gr1.jpg"  alt="Volcano Turri"
                        style="max-width: 100%; height: auto; display: block; margin: 0 auto;">
                      </div>
                </div>
                ...
                <div class="col-lg-4 m-auto shadow"> 
                      <div style="text-align: center; margin: 0 auto; max-width: 100%; col-lg-6 m-auto">
                        <img src="assets/img/Rafting.png"  alt="Volcano Turri"
                        style="max-width: 100%; height: auto; display: block; margin: 0 auto;">
                      </div>
                </div>
                ...
                <div class="col-lg-4 m-auto shadow"> 
                    <div style="text-align: center; margin: 0 auto; max-width: 100%; col-lg-6 m-auto">
                      <img src="assets/img/b3.png"  alt="Volcano Turri"
                      style="max-width: 100%; height: auto; display: block; margin: 0 auto;">
                    </div>
              </div>
            </div>
